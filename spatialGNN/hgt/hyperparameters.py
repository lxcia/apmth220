...
def parse_args():
    ...
    # parser.add_argument('--node_list', type = str, default = project_config.NEUROKG_DIR / 'neuroKG_nodes.csv', help = 'Path to node list.')
    # parser.add_argument('--edge_list', type = str, default = project_config.NEUROKG_DIR / 'neuroKG_edges.csv', help = 'Path to edge list.')
    parser.add_argument('--save_dir', type = str, default = '/n/data1/hms/dbmi/zitnik/lab/users/lucia1215/spatialGNN/results', help = 'Directory for saving files.')
    ...
    parser.add_argument('--resume', type = str, default = None, help = 'Run ID of model to resume training of, in YY_MM_DD_HH_MM_SS format.')
    ...
    parser.add_argument('--sparsity', type=str, default='1%',
                       help='Sparsity level (e.g., "1%", "50%")')
    parser.add_argument('--run_name', type=str, default='1%',
                       help='Sparsity level (e.g., "1%", "50%")')
    parser.add_argument('--loss_weight', type=int, default=1,
                       help='Amount to way ispartof edges by')
    parser.add_argument('--loss_weight2', type=int, default=1,
                       help='Amount to way iscontext edges by')
...
def get_hyperparameters(args):   
    ...
    hparams_dict = {
                ...
                'wandb_save_dir': project_config.RESULTS_DIR / 'wandb' / 'hgt-pretraining',
